...
describe('test MonthPiker component', () => {
    beforeEach(() => {
    ...
    it('render the correact year and month, show correact draopdown status', () => {
    ...
    it('after click the button, dropdown should show, year list&month list should have the correct items', () => {
      ...
      it('click the year&month item, should trigger the right status change', () => {
        ...
        expect(wrapper.state('isOpen')).toEqual(false)
        expect(props.onChange).toHaveBeenCalledWith({year: 2014, month: 1})
      })
